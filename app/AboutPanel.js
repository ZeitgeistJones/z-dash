export default function AboutPanel() {
  ...
  ["Vol/Tx (30d)",                "Average dollar value per transaction over 30 days — a proxy for how serious the traders are. Capped at $1,000 = 100 in scoring"],
  ["Vol/Wlt (30d)",               "Average dollar volume per unique wallet over 30 days. Capped at $5,000 = 100 in scoring"],
  ...
  ["Txs (30d) / Txs (7d)",        "Total on-chain transaction count to this token's contract, 30-day and 7-day windows"],
  ["Txs/User (30d)",              "Average transactions per unique wallet over 30 days. Capped at 10 = 100 in scoring"],
  ["Wallets (30d) / Wallets (7d)","Unique wallet addresses that sent at least one transaction to this token's contract in the window. Includes all on-chain activity, not just DEX trades"],
  ["New Wallets (30d)",           "Wallets active in the last 30 days with no recorded activity in the 31–90 day window before that — new to this token, not necessarily new to Base"],
  ["Returning Wallets (30d)",     "Wallets active in both the last 30 days AND the prior 31–90 day window — users who came back"],
  ["New Wallet % (30d)",          "New Wallets ÷ total Wallets 30d. High % means lots of new arrivals; low % means mostly returning users"],
  ["Retention % (WoW)",           "Wallets retained from last week ÷ this week's active wallets. Measures how well the token holds its users week over week"],
  ["Avg Txs Ret (7d)",            "Average transaction count for wallets active both this week and last week — measures how engaged the loyal users are, not just whether they returned"],
  ["Traders (30d)",               "Unique wallet addresses that executed a DEX buy or sell in the last 30 days, from dex.trades. Different from Wallets 30d which counts all contract interactions"],
  ["Buyers (30d) / Buyers (7d)",  "Unique wallets that bought this token on a DEX in the 30-day and 7-day windows"],
  ...
  ["Buy/Sell Ratio (7d)",         "Buyers 7d ÷ all unique sellers this week. Above 1.0 means more buying wallets than selling wallets this week"],
  ...
  ["Top10 % (30d)",               "Share of all 30-day transactions from the top 10 most active wallets. Lower is healthier — high concentration is penalised in Quality and Risk"],
