  ...
  for (let i = 0; i < addresses.length; i += batchSize) {
    ...
    try {
      ...
      for (const token of data) {
        ...
        lookup[addr] = {
          priceUsd: attrs.price_usd != null ? parseFloat(attrs.price_usd) : null,
          marketCapUsd:
            attrs.market_cap_usd != null ? parseFloat(attrs.market_cap_usd) : null,
          fdvUsd: attrs.fdv_usd != null ? parseFloat(attrs.fdv_usd) : null,
          volume24h:
            attrs.volume_usd?.h24 != null ? parseFloat(attrs.volume_usd.h24) : null,
          priceChange24h:
