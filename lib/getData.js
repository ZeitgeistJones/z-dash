...
export async function getDashboardData() {
  ...
  const enrichedWithAddress = tokensWithAddress.map((token) => {
    ...
    return {
      ...
      Prof: prof,
      "Qlty %": duneRow?.["Qlty %"] ?? duneRow?.["Qlty"] ?? null,
      "Vol 30d": duneRow?.["Vol 30d"] ?? null,
      "Vol/Tx": duneRow?.["Vol/Tx"] ?? duneRow?.["VolTx"] ?? null,
      "Vol/Wlt": duneRow?.["Vol/Wlt"] ?? duneRow?.["VolWlt"] ?? null,
      "Vol Grw %": volumeGrowth,
      "Txs 30d": duneRow?.["Txs 30d"] ?? null,
      "Txs 7d": duneRow?.["Txs 7d"] ?? null,
      "Tx Grw %": duneRow?.["Tx Grw %"] ?? duneRow?.["Tx Grw"] ?? null,
      "Txs/User": duneRow?.["Txs/User"] ?? duneRow?.["TxsUser"] ?? null,
      "Wallets 30d": duneRow?.["Wallets 30d"] ?? null,
      "Wallets 7d": duneRow?.["Wallets 7d"] ?? null,
      "User Grw %": duneRow?.["User Grw %"] ?? duneRow?.["User Grw"] ?? null,
      "New Wallets": duneRow?.["New Wallets"] ?? duneRow?.["New 30d"] ?? null,
      "Returning Wallets": duneRow?.["Returning Wallets"] ?? duneRow?.["Return 30d"] ?? null,
      "New %": duneRow?.["New %"] ?? duneRow?.["New"] ?? null,
      "Retention %": duneRow?.["Retention %"] ?? duneRow?.["Retention"] ?? null,
      ...
      "Top10 %": duneRow?.["Top10 %"] ?? duneRow?.["Top10"] ?? null,
      "Risk %": duneRow?.["Risk %"] ?? duneRow?.["Risk"] ?? null,
